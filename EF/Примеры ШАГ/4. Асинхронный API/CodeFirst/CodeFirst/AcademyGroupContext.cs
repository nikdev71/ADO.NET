...
namespace CodeFirst
{
    ...
    public class AcademyGroupContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            // optionsBuilder.UseLazyLoadingProxies().UseSqlServer(@"Server=DESKTOP-G30VB0K\MSSQLSERVER01;Database=AcademyGroupDB;Integrated Security=SSPI;TrustServerCertificate=true");
          ...
          //  new MySqlServerVersion(new Version(10, 4, 27))); // SELECT VERSION(); команда получения версии в среде MySQL Workbench
        }
    }
}
